...
\author[A. Sim\'on, E. Freire, I. D\'iaz, A. Feij\'oo, P. Rey, J. L\'opez-Cacheiro, C. Fern\'andez]
       {\'Alvaro \surname{Sim\'on}, Esteban \surname{Freire}, Ivan \surname{D\'iaz}, Alejandro \surname{Feij\'oo}, Pablo \surname{Rey}, Javier \surname{L\'opez-Cacheiro}, Carlos \surname{Fern\'andez}}
...
\bibitem{Dillon2010}
Dillon, T. and Chen Wu and Chang, E.: Cloud Computing: Issues and Challenges.
Advanced Information Networking and Applications (AINA), 2010 24th IEEE International Conference, pp.~27--33

\bibitem{Hoffa2008}
Hoffa, C. and Mehta, G. and Freeman, T. and Deelman, E. and Keahey, K. and Berriman, B. and Good, J.: On the Use of Cloud Computing for Scientific Workflows.
...
\bibitem{Xi2012} 
Chunxiao Li and Raghunathan, A. and Jha, N.K.: A Trusted Virtual Machine in an Untrusted Management Environment.
Services Computing, IEEE Transactions, 
Vol.~5, 2012, No.~4, pp.~472--483

\bibitem{Django2013}
Armstrong, Django and Espling, Daniel and Tordsson, Johan and Djemame, Karim and Elmroth, Erik: Runtime Virtual Machine Recontextualization for Clouds.
Lecture Notes in Computer Science, Euro-Par 2012: Parallel Processing Workshops, 
Vol.~7640, pp.~567--576

\bibitem{Laszewski2012} 
von Laszewski, G. and Diaz, J. and Fugang Wang and Fox, G.C.: Comparison of Multiple Cloud Frameworks
Cloud Computing (CLOUD), 2012 IEEE 5th International Conference, pp.~734--741

\bibitem{Diaz2012} 
Diaz, J. and von Laszewski, G. and Fugang Wang and Fox, G.: Abstract Image Management and Universal Image Registration for Cloud and HPC Infrastructures,
Cloud Computing (CLOUD), 2012 IEEE 5th International Conference, pp.~463--470

\bibitem{Maurer2013}
Michael Maurer and Ivona Brandic and Rizos Sakellariou: Adaptive resource configuration for Cloud infrastructure management.
Future Generation Computer Systems,
Vol.~29, 2013, No.~2, pp.~472--487

\bibitem{Schwarzkopf2012}
Schwarzkopf, Roland and Schmidt, Matthias and Strack, Christian and Martin, Simon and Freisleben, Bernd: Increasing virtual machine security in cloud environments.
Journal of Cloud Computing,
Vol.~1, 2012, No.~1, pp.~1-12

\bibitem{Zhao2012} 
Yong Zhao and Yanzhe Zhang and Wenhong Tian and Ruini Xue and Cui Lin: Designing and Deploying a Scientific Computing Cloud Platform.
Grid Computing (GRID), 2012 ACM/IEEE 13th International Conference, pp.~104--113

\bibitem{Goasguen2012}
Sebastien Goasguen and Belmiro Moreira and Ewan Roche and Ulrich Schwickerath: Lxcloud : a prototype for an internal cloud in HEP. Experiences and lessons learned.
Journal of Physics: Conference Series,
Vol.~396, 2012, No.~3

\bibitem{Xiaolong2012}
Xiaolong Wen and Genqiang Gu and Qingchun Li and Yun Gao and Xuejie Zhang: Comparison of open-source cloud management platforms: OpenStack and OpenNebula.
...
\bibitem{wnodes}
Davide Salomoni and Alessandro Italiano and Elisabetta Ronchieri: WNoDeS, a tool for integrated Grid and Cloud access and computing farm virtualization.
Journal of Physics: Conference Series,
Vol.~331, 2011
