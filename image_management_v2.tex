...
Having shown that the use of Hepix imagelists can provide a distributed image distribution framework, using IGTF based identity provison, and the Hepix image endorsement policies as a guide it is clear that using this model and the provided tooos of vmcatcher and vmcaster, the EGI Fed Cloud taskforce needs to develop policies applicable to a wider range of comunites to build this federation.
