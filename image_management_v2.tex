...
However Cloud implementation neutrality increases the inseparability challenges. A federated cloud increases this difficulty, as different clouds with corresponding APIs, Appliance formats, and different contextualisation mechanism must be supported in a truly federated Cloud. 
